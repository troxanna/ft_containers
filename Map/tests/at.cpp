...
int main()
{
  // (1) Default constructor
	...
	std::cout << "STD:\n";
	std::cout << "something: " << stdMap1.at("something") << std::endl;
	std::cout << "something: " << stdMap1.at("none") << std::endl;

	std::cout << "FT:\n";
	std::cout << "something: " << ftMap1.at("something") << std::endl;
	std::cout << "something: " << ftMap1.at("none") << std::endl;
