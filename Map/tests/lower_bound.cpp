...
{ 
	...
	std::cout << "STD: \n";
	std::cout << '(' << (stdNums.lower_bound(1)).operator*().first << ':' << (stdNums.lower_bound(1)).operator*().second << ") ";

	std::cout << std::endl;
	std::cout << "FT: \n";
	std::cout << '(' << (ftNums.lower_bound(1)).operator*().first << ':' << (ftNums.lower_bound(1)).operator*().second << ") ";
